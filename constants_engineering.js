...
export const tracks: Tracks = {
  "MOBILE": {
    ...
    "milestones": [{
      ...
      "examples": [
        ...
        "Built paging adaptor for Android",
  ...
  "WEB_CLIENT": {
    ...
    "milestones": [{
      ...
      "examples": [
        "Made the channel header mobile responsive",
        "Hooked up the action to delete an item from an agenda",
        "Built a new page using existing components",
      ],
    }, {
      "summary": "Develops new instances of existing architecture, or minor improvements to existing architecture",
      "signals": [
      ...
      "examples": [
        "Integrated an existing 3rd party addon into the existing system",
        "Modified the user search component to be more reusable",
      ...
      "examples": [
        ...
        "Designed and pioneered local storage model for settings storage",
      ],
    }, {
